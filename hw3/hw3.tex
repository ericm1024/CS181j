...
\item Consider a plot of flops per L1 cache miss versus \texttt{matrixSize}, as a function of tile size.  What will the flops per cache miss be like for small tile size (like 16)?  How about large tile sizes (like 128)?  Your prediction doesn't have to be right, but it should demonstrate some understanding of what's going on.  In this class, predictions aren't graded on correctness, you just have to do them and show some thinking.
